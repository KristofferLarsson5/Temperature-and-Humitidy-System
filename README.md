...
|----------|----------|----------|----------|
| Raspberry Pi Pico W   | Microcontroller that runs programs and have multiple pins for connections to sensors. Also has the capability of running on WiFi.   | https://www.electrokit.com/produkt/raspberry-pi-pico-w/   | 98kr |
