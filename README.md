...
**5.4 The way that MQTT and Adafruit will be used in this project**
...
And here is an example in Adafruit how it can looks when we create our dashboard and make line charts of the temperature- and humitidy feed. Here I've let the sensors collect data during 10 minutes, but the limitation of the duration which you want to collect data is up to you as an user, you can let it run for as long as you have a power source for the microcontroller and connection to Wi-Fi.
